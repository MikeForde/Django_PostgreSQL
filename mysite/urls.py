...
urlpatterns = [
    ...
    path("read-snomed/int/", views.ReadSnomedIntMapList.as_view(), name="read_snomed_int_list"),
    path("read-snomed/int/new/", views.ReadSnomedIntMapCreate.as_view(), name="read_snomed_int_new"),
    path("read-snomed/int/<int:pk>/edit/", views.ReadSnomedIntMapUpdate.as_view(), name="read_snomed_int_edit"),
    path("read-snomed/int/<int:pk>/delete/", views.ReadSnomedIntMapDelete.as_view(), name="read_snomed_int_delete"),
    path("read-snomed/uk/", views.ReadSnomedUkMapList.as_view(), name="read_snomed_uk_list"),
    path("read-snomed/uk/new/", views.ReadSnomedUkMapCreate.as_view(), name="read_snomed_uk_new"),
    path("read-snomed/uk/<int:pk>/edit/", views.ReadSnomedUkMapUpdate.as_view(), name="read_snomed_uk_edit"),
